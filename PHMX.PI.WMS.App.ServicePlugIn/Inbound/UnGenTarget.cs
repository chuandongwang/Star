...
namespace PHMX.PI.WMS.App.ServicePlugIn.Inbound
{
    ...
    public class UnGenTarget : AbstractOperationServicePlugIn
    {
        ...
        public override void BeginOperationTransaction(BeginOperationTransactionArgs e)
        {
            ...
            var args = connectorService.GetGenTargetSource(this.Context, GenTargetSourceSqlFromInbound.Instance, this.BusinessInfo.GetForm().Id, billIds);
            if (!args.Any())
            {
