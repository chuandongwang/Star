...
namespace PHMX.K3.BD.App.ServicePlugIn.Customer
{
    [Description("从ERP同步客户数据至WMS")]
    //同步字段：名称+编码
    public class SynchronizeCustomerInformation : AbstractOperationServicePlugIn
    {
        ...
        public override void AfterExecuteOperationTransaction(AfterExecuteOperationTransaction e)
        {
            ...
            string targetFormId = PIBDFormPrimaryKey.Instance.Customer();
