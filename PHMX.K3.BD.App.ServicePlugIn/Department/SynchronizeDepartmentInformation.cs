...
namespace PHMX.K3.BD.App.ServicePlugIn.Department
{
    [Description("从ERP同步部门数据至WMS")]
    //同步字段：名称+编码
    public class SynchronizeDepartmentInformation : AbstractOperationServicePlugIn
    {
        ...
        public override void AfterExecuteOperationTransaction(AfterExecuteOperationTransaction e)
        {
            ...
            string targetFormId = PIBDFormPrimaryKey.Instance.Department();
