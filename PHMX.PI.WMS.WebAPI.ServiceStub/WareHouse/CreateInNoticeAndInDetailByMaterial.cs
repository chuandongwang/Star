...
{
    public class CreateInNoticeAndInDetailByMaterial : AbstractWebApiBusinessService
    {
        public CreateInNoticeAndInDetailByMaterial(KDServiceContext context) : base(context)
        {
        }
        /// <summary>
        /// 扫描
